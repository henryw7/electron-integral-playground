...
from electron_integral_code_generator.equation_MD import get_MD_E_term
from electron_integral_code_generator.sympy_utility import remove_whitespace

def test_MD_E_terms():
    E_0_0_0_x = get_MD_E_term(0, 0, 0, "x")
    assert E_0_0_0_x == "1"
    E_0_0_0_y = get_MD_E_term(0, 0, 0, "y")
    assert E_0_0_0_y == "1"
    E_1_0_0_x = get_MD_E_term(1, 0, 0, "x")
    assert E_1_0_0_x == "PAx"
    E_1_0_0_y = get_MD_E_term(1, 0, 0, "y")
    assert E_1_0_0_y == "PAy"
    E_1_0_1_y = get_MD_E_term(1, 0, 1, "y")
    assert E_1_0_1_y == "one_over_two_p"
    E_0_1_0_y = get_MD_E_term(0, 1, 0, "y")
    assert E_0_1_0_y == "PBy"
    E_0_1_1_y = get_MD_E_term(0, 1, 1, "y")
    assert E_0_1_1_y == "one_over_two_p"
    E_1_1_0_y = get_MD_E_term(1, 1, 0, "y")
    assert remove_whitespace(E_1_1_0_y) == remove_whitespace("PAy * PBy + one_over_two_p")
    E_1_1_1_y = get_MD_E_term(1, 1, 1, "y")
    ...
    E_3_3_3_z = get_MD_E_term(3, 3, 3, "z")
    ...
    E_3_3_6_z = get_MD_E_term(3, 3, 6, "z")
